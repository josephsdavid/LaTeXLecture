...
$$4+5=6$$
\begin{equation}
y _ { x x } = \frac { \partial ^ { 2 } y } { \partial x ^ { 2 } } = \left( \frac { \partial } { \partial \xi } + \frac { \partial } { \partial \eta } \right) \left( \frac { \partial y } { \partial \xi } + \frac { \partial y } { \partial \eta } \right) = \frac { \partial ^ { 2 } y } { \partial \xi ^ { 2 } } + 2 \frac { \partial ^ { 2 } y } { \partial \xi \partial \eta } + \frac { \partial ^ { 2 } y } { \partial \eta ^ { 2 } }
\end{equation}
